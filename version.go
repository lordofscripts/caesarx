 ...
 *							 go-caesarx
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * Extended Caesar Cipher for the masses suitable for modern alphabets.
 *-----------------------------------------------------------------*/
package caesarx
 ...
 *-----------------------------------------------------------------*/
const (
	MANUAL_VERSION string = "1.3" // in case vcsVersion not injected during link phase
